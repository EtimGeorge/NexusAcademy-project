...
const featuredCourses = [
    {
        ...
        description: "Learn to generate viral content ideas, write compelling copy, and create stunning visuals with AI.",
        price: "Starts at $299",
    ...
    },
    {
        ...
        description: "Automate tedious tasks, analyze data for key insights, and build custom AI agents to streamline your workflows.",
        price: "Starts at $399",
        flexibility: "Self-Paced",
    ...
    },
    {
        ...
        description: "Go beyond using tools. Learn to architect and build your own multi-step AI agents using APIs and vector databases.",
        price: "Starts at $999",
...
const whyNexusFeatures = [
    { title: "24/7 Personalized Support", description: "No human teacher can offer this. Our AI Tutor provides instant, context-aware answers whenever you're stuck." },
    { title: "Learn by Doing", description: "The interactive exercises on WhatsApp and the AI Playground on the site make the learning active, not passive." },
    { title: "Blended Learning", description: "You combine the best of self-paced online courses with the feel of a live, interactive bootcamp." }
];

const testimonials = [
    { name: "Aisha (The Creator)", role: "Social Media Manager", quote: "Nexus Academy completely changed my workflow. I'm creating higher quality content in half the time. The AI tutor is a game-changer!", image: "https://images.pexels.com/photos/415829/pexels-photo-415829.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" },
    { name: "David (The Upskiller)", role: "Marketing Professional", quote: "I was able to build an automation agent that saves my team 10 hours a week. This course paid for itself in the first month. Incredible ROI.", image: "https://images.pexels.com/photos/614810/pexels-photo-614810.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" },
    { name: "Sam (The Builder)", role: "Developer", quote: "I finally understand how to think about and build with LLMs. The Agentic Architect program was exactly the deep-dive I needed.", image: "https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" }
];

const blogPosts = [
    { category: "Tool Spotlight", title: "Kling vs Runway: Which AI Video Tool is Right for You?", date: "July 22, 2024", link: "#" },
    { category: "Workflow Wednesday", title: "How to Build a Custom GPT to Analyze Customer Feedback", date: "July 17, 2024", link: "#" },
    { category: "Future Forward", title: "The 'AI Skills Gap' is Here. Here's How to Get Ahead.", date: "July 15, 2024", link: "#" }
];
...
export async function render() {
    const pageHtml = await (await fetch('/src/pages/HomePage/HomePage.html')).text();
    ...
    navbarContainer.innerHTML = await (await fetch('/src/components/Navbar/Navbar.html')).text();
    
    // Inject the dynamically generated content into the correct containers
    element.querySelector('.courses-grid').innerHTML = featuredCourses.map(createCourseCardHtml).join('');
    element.querySelector('.features-grid').innerHTML = whyNexusFeatures.map(createFeatureCardHtml).join('');
    element.querySelector('.testimonials-grid').innerHTML = testimonials.map(createTestimonialCardHtml).join('');
    element.querySelector('.blog-grid').innerHTML = blogPosts.map(createBlogPostCardHtml).join('');
